...
\section{Radiometri}
Radiometri beskriver kvantificering af elektromagnetisk stråling i fysiske enheder. Centrale radiometriske størrelser omfatter radiant flux, irradiance, radiance og radiant exitance \cite[s.~423]{Pedrotti2017}. I dette projekt er særligt radiant flux, irradians og responsivitet relevante. Radiant flux $\Phi_e$ beskriver den samlede optiske effekt i watt. Irradians $E_e$ beskriver den optiske effekt per areal på en overflade:
\begin{equation}
    E_e=\frac{\Phi_e}{A}.
\end{equation}
