...
\begin{itemize}
    ...
    Fremadspændingen $V_f$ varierer mellem bølgelængder. En IR-LED kan eksempelvis have en fremadspænding omkring \SI{1.3}{V}, mens en blå LED kan ligge omkring \SI{3.3}{V}. Forskellen skyldes primært halvledermaterialets båndgab. Materiale og dotering bestemmer samtidig LED'ens centerbølgelængde og spektrale bredde \cite[slide~28]{Jakobsen2025LightSources}.
