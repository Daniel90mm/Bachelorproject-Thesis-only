...
Herunder er en oversigt over de vigtigste kliniske iltparametre \cite{Pltz1998,Nitzan2014, Webster1997, Mesquida2013}:
...
Ved et isobestisk punkt (eksempelvis ca.\ \SI{800}{nm}) er absorptionskoefficienterne for $\text{HbO}_2$ og $\text{Hb}$ identiske: $\varepsilon_{\text{HbO}_2}(\SI{800}{nm}) = \varepsilon_{\text{Hb}}(\SI{800}{nm})$. Dette punkt er klinisk relevant, da en måling her er uafhængig af iltmætningen og derfor kan anvendes som referencekanal, selvom det ikke kan bruges til at skelne mellem $\text{HbO}_2$ og $\text{Hb}$.
...
end NIR-lys ved \SI{940}{nm} fra rene Rayleigh-spredere. Dette forhold er et idealiseret eksempel og beskriver ikke den samlede vævsspredning, som i praksis domineres af større spredere.
