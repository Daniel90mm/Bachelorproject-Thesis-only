...
Resultaterne viser, at det udviklede system kan måle et PPG-signal i transmissionsgeometri gennem en finger og udtrække relevante parametre som puls og et proof-of-concept-estimat for SpO$_2$. Projektets centrale resultat er derfor, at den samlede kæde fra LED-emission, fotodetektion, analog signalbehandling og digital analyse fungerer som en prototype.
...
Valget af \SI{660}{nm} og \SI{940}{nm} blev oprindeligt baseret på det klassiske to-bølgelængdeprincip i pulsoximetri. Ved \SI{660}{nm} er forskellen mellem Hb- og HbO$_2$-absorption tydelig, mens NIR-kanalen omkring \SI{940}{nm} giver identisk men omvendt absorptions information, bedre transmission gennem væv samt bedre responsivitet hos fotodioden. Resultaterne understøtter dette valg på flere niveauer, men viser samtidig, at de praktiske bølgelængder skal forstås som spektrale bånd og ikke som ideelt diskrete bølgelængder.

Den spektrometriske karakterisering viste, at den røde LED havde et målt peak ved \SI{664.99}{nm}, en afvigelse på kun \SI{4.99}{nm} fra databladets angivne bølgelængde, og at den røde LED i det kommercielle Braun-pulsoximeter lå ved \SI{663.5}{nm}. Dette understøtter placeringen af den røde bølgelængde i det udviklede system.

\SI{940}{nm}-LED'en havde derimod et målt peak ved \SI{951.79}{nm}, en afvigelse på knap \SI{12}{nm} fra databladets angivne bølgelængde. Det viser, at den praktiske NIR-måling er forskudt i forhold til den betegnelse, komponenten var købt ud fra. Afvigelsen er relevant for fortolkningen af ratio-of-ratios, fordi hæmoglobinernes ekstinktionskoefficienter ændrer sig med bølgelængden. Dette er en kendt problemstilling for pulsoximetri med LED'er, hvor den faktiske LED-bølgelængde kan afvige fra den bølgelængde, der er angivet i databladet \cite[s.~35]{Webster1997} \cite{Ruberry2025}.
...
\paragraph{Støj og signalbalancering.}
...
Den elektriske indkobling peger især på layoutet omkring fotodioden og TIA'ens inverterende indgang. En mulig forbedring ville være at reducere ledningslængderne til fotodioden, twiste fotodiodeforbindelserne og eventuelt afskærme dem med en jordet skærm.

En alternativ tilgang er at kombinere hylster og TIA på samme PCB, så fotodiode-til-TIA-signalgangen bliver så kort som muligt. Tilsvarende kunne kabelføring mellem moduler forbedres ved at twiste relevante signal- og returledere i JST-XH-forbindelserne. En mere avanceret version kunne også undersøge en differentiel TIA-topologi, hvis netrelateret støj fortsat dominerer \cite[s.~82--83]{Webster1997}.

\paragraph{Hardware og software.}
Det var desuden ikke klart, om ustabilitet i de endelige puls- og SpO$_2$-estimater skyldtes hardware eller software. Det analoge gain-output viste en tydelig multipleksstruktur, men de efterfølgende estimater kunne stadig fluktuere betydeligt. Dette peger på, at både hardwarekvalitet, spændingsniveau på gain-output, demultipleksering, peak-detektion og AC/DC-estimering påvirker det endelige resultat. En mere systematisk debugging, hvor faste testsignaler indføres i softwarekæden, ville gøre det lettere at adskille hardwarefejl fra signalbehandlingsfejl.

\section{Sammenligning med reference og projektets gyldighed}
\paragraph{Klinisk gyldighed.}
Det kommercielle Braun-pulsoximeter blev anvendt som praktisk reference, men ikke som "ground-truth". Sammenligningen var nyttig til at kontrollere, om det udviklede system gav fysiologisk plausible værdier, men den kan ikke erstatte en egentlig kalibrering mod arteriel iltmætning målt ved blodgas.
...
\end{equation}
og forholdet mellem $\varepsilon_{\mathrm{eff}}$ ved de to LED-bølgelængder skalerer ratio-of-ratios. Ved $S = 0.99$ giver de tabulerede værdier følgende forhold i $\mathrm{M}^{-1}\mathrm{cm}^{-1}$:
\begin{equation}
...
Den vigtigste forbedring ville være at øge systemets reproducerbarhed over flere målinger. I den nuværende prototype kunne en måling give en realistisk og stabil puls, mens SpO$_2$-estimatet varierede betydeligt mellem målekørsler. Dette tyder på, at systemet er følsomt over for fingerplacering, fingertryk, signalbalancering, støj og signalbehandling. En fremtidig version bør derfor først fokusere på reproducerbarhed, før den optimeres mod absolut SpO$_2$-nøjagtighed.
...
På softwaresiden bør signalbehandlingen valideres mere systematisk. Det kunne gøres med syntetiske PPG-signaler, hvor puls, støj, AC/DC-forhold og forholdet mellem de to bølgelængder er kendt på forhånd, eller med et optisk testsignal med kendt puls og iltmætning \cite[s.~112]{Webster1997}. Dermed kan det testes, om demultipleksering, peak-detektion og SpO$_2$-beregning fungerer korrekt uafhængigt af hardware. Dette ville gøre det lettere at afgøre, om ustabile estimater skyldes den analoge måling eller den digitale del.
