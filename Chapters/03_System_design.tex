...
LED-driverstadiet blev adskilt fra resten af signalkæden for at reducere kobling af switching-transienter ind i det følsomme analoge målekredsløb og for at levere tilstrækkelig strøm til LED'erne. AD3'ens bølgeformningsudgang kan levere op til \SI{40}{mA} før hardware-cutoff, se figur \ref{fig:ad3_datasheet} i appendiks, hvilket er utilstrækkeligt til f.eks. \SI{940}{nm}-LED'en, der kan drives med strømme op mod \SI{50}{mA}. Bølgeformningsudgangene blev derfor udelukkende anvendt som styresignaler, mens selve LED-strømmen blev leveret fra et separat \SI{9}{V}-batteri. For at definere MOSFET'ens gate-source-spænding blev AD3'ens GND og batteriets GND forbundet.
...
TIA'en er baseret på en OP27G, som er en lavstøjs præcisions operationsforstærker. TIA'en er vist i figur \ref{fig:PD_ingen_bias_TIA}, og er også vist i PCB-skemaet i figur \ref{fig:TIA_LP} i appendiks.
...
Den parallelkoblede feedbackkondensator $C_f$ anvendes til at forbedre stabiliteten i TIA'en, særligt i samspillet mellem fotodiodens kapacitans og operationsforstærkerens dynamik. De valgte komponentværdier blev bestemt ud fra litteratur og iterativt design \cite{analog_tia_stabilize}:

\begin{itemize}
    \item $R_f = \SI{2.2}{\mega\ohm}$
