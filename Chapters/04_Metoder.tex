...
Derefter blev systemet kørt i \SI{10}{s} før dataopsamling for at lade LED-driver, analogkæde og softwaresekvens stabilisere sig. Til sidst blev der udført en minutlang måling med en multipleksingsfrekvens på \SI{7.41}{Hz}.
...
Denne kanalrate er markant lavere end i mange kommercielle pulsoximetre, hvor LED-skift ofte ligger i størrelsesordenen flere hundrede hertz \cite[s.~61]{Webster1997}. I dette projekt blev den lavere frekvens valgt som et bevidst prototypekompromis. De lange \SI{40}{ms}-målevinduer gav midling over et heltalligt antal \SI{50}{Hz}-perioder og dermed robust undertrykkelse af netstøj, men reducerede samtidig den tidslige opløsning og gjorde målingen mere følsom over for bevægelse eller fysiologiske ændringer mellem kanalerne.
...
\begin{equation}
    I_{660} = \frac{\SI{9}{V}-\SI{2}{V}}{\SI{470}{\ohm}} = \SI{14.9}{mA}
\end{equation}
\begin{equation}
    I_{940} = \frac{\SI{9}{V}-\SI{1.35}{V}}{\SI{470}{\ohm}} = \SI{16.3}{mA}
\end{equation}
...
\[
    |I_{940}|=\frac{\SI{0.9}{V}}{\SI{2.21}{\mega\ohm}}=\SI{0.41}{\micro\ampere},
\]
og
\[
    |I_{660}|=\frac{\SI{0.5}{V}}{\SI{2.21}{\mega\ohm}}=\SI{0.23}{\micro\ampere}.
\]
