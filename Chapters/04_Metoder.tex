...
\paragraph{LED-driver kredsløb}
LED-driver boardet blev designet med nedenstående komponenter:
\begin{itemize}
    \item To $R_{\text{limit}} = 470 \ \Omega$
    \item To $R_{\text{Gate}} = 10 \ \text{k}\Omega$
    \item To $R_{\text{pd}} = 100 \ \Omega$
...
$$V_{F,940} = 1.35 \ V  \qquad V_{F,660} = 2 \ V$$
Med disse komponentværdier drives de to LEDer ved:
\begin{equation}
    I_{660} = \frac{9V-2V}{470 \Omega} = 14.9\ \text{mA}
\end{equation}
\begin{equation}
    I_{940} = \frac{9V-1.35V}{470 \Omega} = 16.3\ \text{mA}
\end{equation}
Det fulde LED-driverkredsløb kan ses i appendiks \ref{fig:led_driver_schematic}
...
\begin{enumerate}
    \item Anti-aliasing for AD3'ens sampling. AD3'en sampler kontinuerligt under hver \SI{40}{ms} LED-fase ved \SI{20}{kHz}, og prøverne midles efterfølgende til en værdi per fase. LPF'en bidrager til at dæmpe højfrekvent indhold over Nyquist-frekvensen på \SI{10}{kHz} inden digitalisering. 
